...
export function useGameLogic() {
  ...
  function validateAnswer(submitted) {
    ...
    // determine stake
    const stake = question.isDouble ? (question.wager != null ? question.wager : question.value) : question.value

    const isCorrect = String(question.correct_answer).toLowerCase() === submitted.toLowerCase()

    player.score += isCorrect ? stake : -stake
